...
### Ejemplo Real
```
https://multicampaign.preview.emergentagent.com/edit/noel-rivera?token=qoy6llrBNTjtVPznm89-a5EWoJvuqDokWHyWwgP3J6I
```
...
### Panel de Edición
```
https://multicampaign.preview.emergentagent.com/edit/{slug}?token={token}
```

### Generar Magic Link (Admin)
```
POST https://multicampaign.preview.emergentagent.com/api/admin/mentors/{id}/magic-link?days_valid=7
```
